...
targets = [
	...
	'activation-csd-b2b-pool2': ['10.41.5.18','10.41.5.19','10.41.7.180','10.41.7.181','10.41.7.182','10.41.7.183','10.41.7.184','10.41.7.185','10.41.7.186','10.41.7.187','10.41.7.188','10.41.7.189','10.41.7.190','10.41.7.191','10.41.7.192','10.41.7.194','10.41.7.195','10.41.7.196'],
	'contingency-pool': ['10.41.5.240','10.41.7.134']
...
notificants = "rgadipalli@incomm.com ppiermarini@incomm.com vstanam@incomm.com"
...
def rebootServersV2(envName, targets, serviceName){
	
	echo "my env= ${envName}"
	def stepsInParallel =  targets.collectEntries {
		[ "$it" : { rebootV2(it, serviceName) } ]
	}
	parallel stepsInParallel
