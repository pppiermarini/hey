...
svnUrl="https://svn.incomm.com/svn/fsitRepos/Platforms/GC/shared/vanillarealtime/branches/${Branch}"
		...
		stage('Build'){
			...
			if((userInput != 'Promote') && (userInput != 'Release') && (userInput != 'QABuild')){
				withSonarQubeEnv('sonar'){
					sh "${maven} clean deploy -X -U -DskipTests -Dmaven.javadoc.skip=true sonar:sonar"
				}
