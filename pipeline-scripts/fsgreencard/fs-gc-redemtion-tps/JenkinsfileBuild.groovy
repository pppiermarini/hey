...
svnRepository="https://svn.incomm.com/svn/fsitRepos/Platforms/GC/lib/GreenCard/branches/${Branch}"
		...
		stage('Build'){
			...
			if (userInput == 'Build'){
				...
				//withSonarQubeEnv('sonar'){
					//sh "${maven} clean deploy -DskipTests sonar:sonar" 
				//}
