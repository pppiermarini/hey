...
imageName = "spil-services-generictokenmanager"

imageDeploymentLoc="/app/docker/tmp"

Deploy_Config="${Config}"

configLoc="/app/install/tokenmanager"
gitLoc="docker"

gitYmlInstallFile="spil-tokenmanager-svc-docker-compose.yml"

commandFile="command.sh"

targetenvs="${targetEnv}"

gitRepository="https://github.com/InComm-Software-Development/ctps-spil-services-generictokenmanager.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
