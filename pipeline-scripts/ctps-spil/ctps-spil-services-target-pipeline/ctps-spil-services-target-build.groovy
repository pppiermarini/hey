...
gitRepository="https://github.com/InComm-Software-Development/ctps-spil-services-target.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
emailDistribution="vpilli@incomm.com dstovall@incomm.com vhari@incomm.com mpalve@incomm.com ppiermarini@incomm.com"
//General pipeline
...
imageName = "spil-services-assurance"
		...
		stage('Build-Release'){
			...
			if (userInput == 'Build'){
				...
				withSonarQubeEnv('sonarqube.incomm.com'){
					sh "${maven} -B -f pom.xml -U -X clean compile jib:build sonar:sonar"
