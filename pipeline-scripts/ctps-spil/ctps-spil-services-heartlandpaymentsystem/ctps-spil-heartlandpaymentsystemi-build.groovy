...
gitRepository="https://github.com/InComm-Software-Development/ctps-spil-services-heartlandpaymentsystem.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
imageName = "spl-services-heartlandpaymentsystem"
...
node('docker'){
	try { 
        ...
        stage('Snyk Scans') {
			...
			snykScan(snyk, snykHtml, scanCodeDir, folderBuildName, snykCreds, "${artifactId}", labelScan)
