...
gitRepository = "https://github.com/InComm-Software-Development/ccl-config.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
targets = [
	...
	'stg': ['10.41.6.63'],
	'PROD-POOL1': ['spcclui03fv.fastcard.local'],
	'PROD-POOL2': ['spcclui01fv.fastcard.local']
]
               ...
               if ((target_env=='stg')||(target_env=='PROD-POOL1')||(target_env=='PROD-POOL2'))
                {
                    ...
                    operators= "['psharma', 'mjoshi', 'vhari']"
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	echo " the target is: ${target_hostname}"
			...
			serviceName = "jboss-eap-cfg"
			artifactDeploymentLoc = "/srv/jboss-eap-7.0/standalone-CFG/deployments"
		}
	sh """
