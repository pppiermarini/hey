...
gitRepository="https://github.com/InComm-Software-Development/ccl-order.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
targets = [
	...
	'stg' : ['10.41.6.63'],
	'PROD-POOL1': ['spcclcss01fv.fastcard.local'],
	'PROD-POOL2': ['spcclcss04fv.fastcard.local']
]

emailDistribution="ppiermarini@incomm.com rkale@incomm.com dstovall@incomm.com vhari@incomm.com pchourasia@incomm.com psharma@incomm.com sdhumal@InComm.com rgopal@incomm.com abajaj@incomm.com mjoshi@InComm.com kloganathan@incomm.com"
//General pipeline 
pipelineData="/app/pipeline-data/cclp-order"  
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	echo " the target is: ${target_hostname}"
			if ((target_env=='PROD-POOL1')||(target_env=='PROD-POOL2')){
				serviceName = "jboss-eap-ord"
				artifactDeploymentLoc = "/srv/jboss-eap-7.0/standalone-ORD/deployments"
		}
	sh """
