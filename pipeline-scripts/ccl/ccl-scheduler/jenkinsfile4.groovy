...
gitRepository="https://github.com/InComm-Software-Development/ccl-jobs.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
//General pipeline 
pipelineData="/app/pipeline-data/cclp-jobs"  
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	echo " the target is: ${target_hostname}"
			if ((target_env=='PROD-POOL1')||(target_env=='PROD-POOL2')){
				serviceName = "jboss-eap-job"
				artifactDeploymentLoc = "/srv/jboss-eap-7.0/standalone-JOB/deployments"
		}
	sh """
