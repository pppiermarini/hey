...
targets = [
    'pre-prod':['10.41.7.124', '10.41.7.125'],
    'prod':['10.41.7.121', '10.41.7.122', '10.41.7.123'],
	'prod-azure':['10.114.96.180', '10.114.96.182', '10.114.96.181']
]
...
node('docker'){
	try { 
		...
		stage('Approval Check') {
        	if ((targetEnv == 'pre-prod') || (targetEnv == 'prod') || (targetEnv == 'prod-azure')) {
