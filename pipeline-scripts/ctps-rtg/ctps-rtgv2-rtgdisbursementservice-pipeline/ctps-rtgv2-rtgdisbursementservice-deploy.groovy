...
//ctps-rtgv2-rtgdisbursementservice
...
imageName = "ctps-rtgv2-rtgdisbursementservice"

imageDeploymentLoc="/app/docker/tmp"

Deploy_Config="${Config}"

ymlConfigLoc="/app/install/rtgdisbursementservice/config"
configLoc="/app/install/rtgdisbursementservice/scripts"
gitLoc="src/main/resources/docker/"

gitAppYmlFile="application.yml"
gitYmlInstallFile="docker-swarm-rtgdisbursementservice.yml"

commandFile="command.sh"

targetenvs="${targetEnv}"

gitRepository="https://github.com/InComm-Software-Development/ctps-rtgv2-rtgdisbursementservice.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"

//Targets 
targets = [
    'dev': ['10.42.20.31', '10.42.20.32', '10.42.19.37'],
    'qa': ['10.42.83.134', '10.42.83.135', '10.42.83.144'],
    'uat': ['10.42.50.225', '10.42.50.226', '10.42.50.243']

]

//approval data of list of admins
approvalData = [
	'operators': "[ppiermarini,shaque,vhari,skeshari,wzhan,stadoori]",
	'adUserOrGroup' : 'ppiermarini,shaque,vhari,skeshari,wzhan',stadoori,
