...
targets = [
    'dev':  ['10.42.20.31','10.42.20.32'],
    'qa': ['10.42.83.134', '10.42.83.135'],
    'uat':['10.42.50.225', '10.42.50.226']
]

//Approval Data for deployment
approvalData = [
	'operators': "[ppiermarini,shaque,vhari,stadoori,wzhan,skeshari]",
	'adUserOrGroup' : 'ppiermarini,shaque,vhari,stadoori,wzhan,skeshari',
