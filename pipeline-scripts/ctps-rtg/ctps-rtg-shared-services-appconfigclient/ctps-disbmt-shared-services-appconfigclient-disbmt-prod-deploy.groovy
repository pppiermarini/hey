...
//Config logs
configLogs="/app/install/appconfig-client-service/logs"

//@TODO: Verify Config Loc
configLoc="/app/install/appconfig-client-service/"

//@TODO: Need to know where to scp the prop file
configAppLoc="/app/config/"

deploy_config_application="disbmt-svc"
...
approvalData = [
	'operators': "[ppiermarini,skeshari,vhari,stadoori,wzhan,hpokala,shaque]",
	'adUserOrGroup' : 'ppiermarini,skeshari,vhari,stadoori,wzhan,hpokala,shaque',
