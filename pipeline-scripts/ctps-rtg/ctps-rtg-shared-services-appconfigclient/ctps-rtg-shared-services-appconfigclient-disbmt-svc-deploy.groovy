...
//Updated Targets
targets = [
    'dev':  ['10.42.20.37','10.42.20.38'],
    'qa': ['10.42.83.138','10.42.83.139'],
    'uat':['10.42.50.216', '10.42.50.217'],
    'pre-prod':['10.41.7.160', '10.41.7.161', '10.41.7.162'],
    'prod':['10.41.7.154', '10.41.7.155', '10.41.7.156']
]


//Approval Data for deployment
approvalData = [
	'operators': "[ppiermarini,shaque,snookala,hpokala]",
	'adUserOrGroup' : 'ppiermarini,shaque,snookala,hpokala',
