...
//#################
// launchit-notes-services
// Team doesnt have pom.xml file. Ravinder says its not ready yet. 6/16/2020
//#################
...
gitRepository = "https://github.com/InComm-Software-Development/sop-lit-notes.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
groupId = 'com.incomm.lit.notes'
artifactId = 'lit-note-service'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'lit-note-service.jar'
		...
		stage('Build'){
			...
			if (userInput == 'Build') {
				...
				withSonarQubeEnv('sonarqube.incomm.com'){
					...
					sh "cp target/${artifactId}*.${artExtension} ${artifaceName}"
