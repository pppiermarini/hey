...
gitRepository="https://github.com/InComm-Software-Development/vms-host.git"
//gitBranch="${BRANCH}"
gitCreds="scm-incomm"
...
sh "${jdk}/bin/java -version"
	...
	try { 
		...
		stage('Build'){
				...
				//RITM0386666 sh "${maven} clean deploy -f pom.xml -e -U -DskipTests -Dmaven.wagon.http.ssl.insecure=true -Dmaven.wagon.http.ssl.allowall=true -Dmaven.wagon.http.ssl.ignore.validity.dates=true"
		...
		stage('snyk-scan') {
			...
			snykScanV2debug(snykTokenId, artifactId, artifactVersion)
		}
