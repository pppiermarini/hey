...
artifactDeploymentLoc = "C\$\\bif-redemption-writer-ms\\bif-redemption-writer-ms"
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	bat """
		 ...
		 del \\\\${target_hostname}\\c\$\\bif-redemption-writer-ms\\bif-redemption-writer-ms\\bif-redemption*.jar
