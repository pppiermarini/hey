...
artifactDeploymentLoc = "/var/ifulfill/core"
instanceLogs="/var/ifulfill/core/logs"
...
artifactId = 'ifulfill-core'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'ifulfill-core.jar'
...
//					sh "${maven} clean deploy -U -B sonar:sonar"
					sh "cp ifulfill-core/target/${artifactName} ."
