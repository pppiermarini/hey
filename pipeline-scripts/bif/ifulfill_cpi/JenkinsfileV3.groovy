...
emailDistribution="amohanan@incomm.com"
//General pipeline .

artifactDeploymentLoc = "/var/ifulfill/cpi"
instanceLogs="/var/ifulfill/cpi/logs"
...
artifactId = 'ifulfill-cpi'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'ifulfill-cpi.jar'
...
//					sh "${maven} clean deploy -U -B sonar:sonar"
					...
					sh "cp ifulfill-cpi/target/${artifactName} ."
