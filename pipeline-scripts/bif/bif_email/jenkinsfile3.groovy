...
gitRepository = "https://github.com/InComm-Software-Development/BIF-Email"
...
targets = [
	'dev': ['Sdbifapi280v.uss.net'],
	'dev1': ['Sdaifapi01v.uss.net'],
	'qa': ['sqbifapi278V'],
	'qa1': ['Sqaifapi01V'],
	'uat': ['subifapi302V'],
	'uat1': ['subifapi01V'],
...
//com.incomm.b2b
artifactId = 'bif-ms-email'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'bif-ms-email.jar'
...
//These commands are here only if the script is needed.
//del \\\\${target_hostname}\\c\$\\mule\\mule-standalone-3.7.0\\apps\\${artifactName}
// for /D %%f in (\\\\${HOSTNAME[i]}\\c\$\\mule\\mule-standalone-3.7.0\\apps\\bif-mule*) do @rmdir %%f /Q /S
