...
artifactDeploymentLoc = "/var/ifulfill/serve"
instanceLogs="/var/ifulfill/serve/logs"
...
artifactId = 'ifulfill-serve'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'ifulfill-serve.jar'
...
//					sh "${maven} clean deploy -U -B sonar:sonar"
					...
					sh "cp ifulfill-serve/target/${artifactName} ."
