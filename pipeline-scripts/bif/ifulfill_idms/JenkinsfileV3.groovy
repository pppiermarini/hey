...
artifactDeploymentLoc = "/var/ifulfill/idms/"
instanceLogs="/var/ifulfill/idms/logs"
...
artifactId = 'ifulfill-idms'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'ifulfill-idms.jar'
...
//					sh "${maven} clean deploy -U -B sonar:sonar"
					...
					sh "cp ifulfill-idms/target/${artifactName} ."
