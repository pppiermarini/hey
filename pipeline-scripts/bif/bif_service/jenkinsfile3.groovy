...
gitRepository = "https://github.com/InComm-Software-Development/BIFService.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
artifactDeploymentLoc = "/var/BIFService/bif-api-ms/"
instanceLogs="/opt/BIFService/bif-api-ms/logs"
...
artifactId = 'BIFService'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'BIFService.jar'
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	sshagent([credsName]) {
		sh """
			...
			ssh -q -o StrictHostKeyChecking=no root@${target_hostname} '/bin/chown bifservice:bifservice ${artifactDeploymentLoc}/${artifactName}'
