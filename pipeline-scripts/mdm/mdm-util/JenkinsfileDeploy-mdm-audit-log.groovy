...
artifactId = 'mdm-audit-log'
env_propertyName = 'ART_VERSION'
artExtension = 'war'
artifactName = 'mdm-audit-log.war'
warFolderName = "mdm-audit-log"
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact, envName) {
	...
	//cp -o StrictHostKeyChecking=no -r ${envName}/*.properties root@${target_hostname}:${configFolderLoc}
