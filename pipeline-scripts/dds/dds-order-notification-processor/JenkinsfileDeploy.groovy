...
gitRepository="https://github.com/InComm-Software-Development/digitaldelivery-dds-microservices-dds-order-notification-processor.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc="D\$\\incomm\\microservices\\dds-order-notification-processor"
serviceName="dds-order-notification-processor"
archiveLoc="D\$\\incomm\\archives"
pipeline_id="${env.BUILD_TAG}"

configDeploymentLoc="D\$\\incomm\\microservices\\dds-order-notification-processor\\config"
//tools
...
groupId = 'com.incomm.dds.microservices.order'
artifactId = 'dds-order-notification-processor'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'dds-order-notification-processor.jar'
artifactBareName = 'dds-order-notification-processor'
