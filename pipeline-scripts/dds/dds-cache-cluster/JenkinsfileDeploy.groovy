...
gitRepository="https://github.com/InComm-Software-Development/digitaldelivery-dds-microservices-dds-cache-cluster.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc="D\$\\incomm\\microservices\\dds-cache-cluster"
serviceName="dds-cache-cluster"

pipeline_id="${env.BUILD_TAG}"
archiveLoc="D\$\\incomm\\archives"
configDeploymentLoc="D\$\\incomm\\microservices\\dds-cache-cluster\\config"
...
artifactId = 'dds-cache-cluster'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'dds-cache-cluster.jar'
artifactBareName = 'dds-cache-cluster'
