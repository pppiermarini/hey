...
gitRepository="https://github.com/InComm-Software-Development/digitaldelivery-dds-microservices-dds-cache-manager-api-service.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"

archiveLoc="D\$\\incomm\\archives"
artifactDeploymentLoc="D\$\\incomm\\microservices\\dds-cache-manager-api"
configDeploymentLoc="D\$\\incomm\\microservices\\dds-cache-manager-api\\config"
serviceName="dds-cache-manager"
...
groupId = 'com.incomm.dds.microservices.cache'
artifactId = 'dds-cache-manager-api'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'dds-cache-manager-api.jar'
artifactBareName = 'dds-cache-manager-api'
//artifactName = ''
