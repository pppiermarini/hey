...
artifactDeploymentLoc="D\$\\incomm\\microservices\\dds-order-routing-service"
serviceName="dds-order-routing-service"

pipeline_id="${env.BUILD_TAG}"

//Adding Git creds here
gitRepository="https://github.com/InComm-Software-Development/digitaldelivery-dds-microservices-dds-order-routing-service.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
configDeploymentLoc="D\$\\incomm\\microservices\\dds-order-routing-service\\config"
///Artifact Resolver	input specifics
repoId = 'maven-release'
groupId = 'com.incomm.dds.microservices.order'
artifactId = 'dds-order-routing-service'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'dds-order-routing-service.jar'
artifactBareName = 'dds-order-routing-service'
