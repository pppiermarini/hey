...
gitRepository="https://github.com/InComm-Software-Development/digitaldelivery-dds-microservices-dds-order-fulfillment-processor.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc="D\$\\incomm\\microservices\\dds-order-fulfillment-processor"
archiveLoc="D\$\\incomm\\archives"
serviceName="dds-order-fulfillment-processor"

pipeline_id="${env.BUILD_TAG}"

configDeploymentLoc="D\$\\incomm\\microservices\\dds-order-fulfillment-processor\\config"
...
artifactId = 'dds-order-fulfillment-processor'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'dds-order-fulfillment-processor.jar'
artifactBareName = 'dds-order-fulfillment-processor'
