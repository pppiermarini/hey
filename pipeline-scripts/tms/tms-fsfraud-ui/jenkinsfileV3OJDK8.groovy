...
gitRepository = "https://github.com/InComm-Software-Development/cfes-tmsfs-fraudui.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
targets = [
	'dev_sdtmsfrdapp01v': ['10.42.18.212'],
	'dev_sdtmsfrdapp02v': ['10.42.18.213'],
	'dev_sdtmsfrdapp03v': ['10.42.18.214'],
	'dev_sdtmsfrdapp04v': ['10.42.18.215'],
	'qa_SQFRDAPP01v': ['10.42.82.39'],
	'qa_SQFRDAPP02v': ['10.42.82.40'],
	'qa_sqltmsfrdapp01v': ['10.42.83.107'],
	'qa_sqltmsfrdapp02v': ['10.42.83.108'],
	'prod_spltmsfsfrdapp01fv': ['10.41.7.116'],
	'prod_spltmsfsfrdapp02fv': ['10.41.7.117'],
	'prod_spltmsfsfrdapp03fv': ['10.41.7.118']
	
]

emailDistribution="dstovall@incomm.com ppiermarini@incomm.com schahanapally@incomm.com nprasobhan@incomm.com"
//General pipeline 

approvalData = [
	'operators': "[awadhwa,schahanapally,nprasobhan,dstovall]",
	'adUserOrGroup' : 'awadhwa,schahanapally,nprasobhan,dstovall',
...
instanceLogs="/var/opt/pivotal/pivotal-tc-server-standard/tmsfs-fraud-ui-instance/logs"
	...
	try {
		...
		stage('Build'){
			...
			if (userInput == 'Build') {
				...
				sh "cp tmsfs-webapp-fraud-harness/target/${artifactName} . "
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	sh """
		...
		scp -r -q -o StrictHostKeyChecking=no configurations/${myenv}/${prop} root@${target_hostname}:${libDeploymentLoc}
