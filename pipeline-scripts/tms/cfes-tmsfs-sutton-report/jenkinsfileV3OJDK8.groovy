...
gitRepository = "https://github.com/InComm-Software-Development/cfes-tmsfs-sutton-report.git"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
artifactDeploymentLoc = "/opt/tmsfs-sutton-report"
...
artifactId ='tms-fs-sutton-report'
env_propertyName ='ART_VERSION'
artExtension ='jar'
artifactName ='.jar'

artifactRealName = 'tms-fs-sutton-report' 
