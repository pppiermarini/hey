...
gitRepository = "https://github.com/InComm-Software-Development/cfes-tms-fraudmodule.git"
//gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
targets = [
	...
	'prod_4' : ['sptmsfrdapp04v'],
	'prod_5' : ['sptmsfrdapp05v'],
	'prod_6' : ['sptmsfrdapp06v']
]
...
stage('SonarQube Quality Gate Check') {
	...
	stage('Deployment'){
		...
		if ((userInput == 'Build') || (userInput == 'Promote')) {
			...
			deployComponents(target_env, targets[target_env], "${artifactId}-${artifactVersion}.${artExtension}")
