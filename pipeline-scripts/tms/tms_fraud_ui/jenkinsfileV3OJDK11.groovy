...
gitRepository = "https://github.com/InComm-Software-Development/cfes-tms-fraudui"
gitBranch = "${Branch}"
gitCreds = "scm-incomm"
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	sh """
		...
		scp -r -q -o StrictHostKeyChecking=no configurations/${target_env}/${star} root@${target_hostname}:${libDeploymentLoc}
