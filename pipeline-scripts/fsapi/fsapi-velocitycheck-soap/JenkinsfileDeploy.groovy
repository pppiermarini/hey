...
gitRepository="hhttps://github.com/InComm-Software-Development/FSAPI-VelocityCheck_WebServices_SOAP.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
targets = [
    ...
    'qa':   ['10.42.84.112','10.42.84.113'],
]

emailDistribution="ppiermarini@incomm.com"
//General pipeline

artifactDeploymentLoc ="/opt/incomm-velocitycheck-soap/deploy/"
propertiesDeploymentLoc="/opt/incomm-velocitycheck-soap/config"
commonProperties="src/main/resources/common/"
srcProperties="src/main/resources/${targetEnv}/"

serviceName="standalone-vanilla.service"
...
groupId = 'com.incomm.vanillaws'
artifactId = 'vanilla-ws'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'vanilla-ws.jar'
...
def deploy(target_hostname, artifactDeploymentLoc, Artifact) {
	...
	sshagent([credsName]) {
		...
		scp ${Artifact} root@${target_hostname}:${artifactDeploymentLoc}
		scp ${srcProperties}*.properties root@${target_hostname}:${propertiesDeploymentLoc}
		scp ${commonProperties}* root@${target_hostname}:${propertiesDeploymentLoc}
