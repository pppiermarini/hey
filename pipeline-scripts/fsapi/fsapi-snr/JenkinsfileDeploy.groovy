...
gitRepository="https://github.com/InComm-Software-Development/FSAPI-SNR.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc ="/opt/incomm-snr/deploy/"
propertiesDeploymentLoc="/opt/incomm-snr/config"

srcProperties="src/main/resources/${targetEnv}/"
commonProperties="src/main/resources/common/"

serviceName="standalone-snr.service"
...
groupId = 'com.incomm'
artifactId = 'serial-number-replenishment'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'SerialNumberReplenishment.jar'
