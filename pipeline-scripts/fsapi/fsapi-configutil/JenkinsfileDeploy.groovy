...
gitRepository="https://github.com/InComm-Software-Development/FSAPI-CONFIGUTILS.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc ="/opt/incomm-configutils/deploy/"
propertiesDeploymentLoc="/opt/incomm-configutils/config"

srcProperties="src/main/resources/${targetEnv}/"
commonProperties="src/main/resources/common/"

serviceName="standalone-configutils.service"
...
groupId = 'com.incomm'
artifactId = 'FSAPIConfigUtils'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'FSAPIConfigUtils.jar'
