...
gitRepository="https://github.com/InComm-Software-Development/FSAPI-B2B-PostBack.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
artifactDeploymentLoc ="/opt/incomm-b2bpostback/deploy/"
propertiesDeploymentLoc="/opt/incomm-b2bpostback/config"

srcProperties="src/main/resources/${targetEnv}/"
commonProperties="src/main/resources/common/"

serviceName="standalone-b2bpostback.service"
...
groupId = 'com.incomm'
artifactId = 'B2B_Postback'
env_propertyName = 'ART_VERSION'
artExtension = 'jar'
artifactName = 'B2B_Postback.jar'
