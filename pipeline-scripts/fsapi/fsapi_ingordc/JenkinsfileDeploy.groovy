...
gitRepository="https://github.com/InComm-Software-Development/FSAPI-IngoRDC.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
//General pipeline
artifactDeploymentLoc ="/opt/incomm-ingordc/deploy"
propertiesDeploymentLoc="/opt/incomm-ingordc/config"
commonProperties="src/main/resources/common/"
srcProperties="src/main/resources/${targetEnv}/"

serviceName="standalone-ingordc.service"
