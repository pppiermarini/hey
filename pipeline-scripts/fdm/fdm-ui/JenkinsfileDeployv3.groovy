...
gitRepository="https://github.com/InComm-Software-Development/FDM-ui.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
targets = [
    ...
    'qa':   ['10.42.82.77'],
	'stg':  ['ssfdmapp87v']
	'prod': ['10.40.7.176 ', '10.40.7.177'],
]

//10.42.82.77  sqlafdmapp03v
//10.40.7.176 spfdmapp01v
//10.40.7.177 spfdmapp02v
...
Num -= 1
	...
	sh """
		ssh -i ~/.ssh/pipeline -q -o StrictHostKeyChecking=no root@${target_hostname} 'rm -rf  ${tmpLocation}/html && rm -rf ${tmpLocation}/${artifactName} && rm -rf ${tmpLocation}/html_bak_${Num}'
