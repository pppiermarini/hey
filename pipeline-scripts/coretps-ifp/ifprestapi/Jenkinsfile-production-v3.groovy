...
operators= "['sthulaseedharan','ppiermarini']"

testName = "myTest"

targets = [
	'prod_servers_all': ['splifp01v','splifp02v','splifp03v','splifp04v','splifp05v','splifp06v','splifp07v','splifp08v','splifp09v','splifp10v'],
	'prod_splifp01v': ['splifp01v'],
	'prod_splifp02v': ['splifp02v'],	
	'prod_splifp03v': ['splifp03v'],	
	'prod_splifp04v': ['splifp04v'],
	'prod_splifp05v': ['splifp05v'],
	'prod_splifp06v': ['splifp06v'],
	'prod_splifp07v': ['splifp07v'],
	'prod_splifp08v': ['splifp08v'],
	'prod_splifp09v': ['splifp09v'],
	'prod_splifp10v': ['splifp10v'],
]
		   ...
		   if ((ENV[0] =='prod'))
			{
				...
				def Deployment_approval = input message: 'Deploying to PROD', ok: 'Continue', parameters: [choice(choices: ['', 'Abort', 'Proceed'], description: 'Please confirm deployment', name: 'approval_status')], submitter: 'sthulaseedharan,ppiermarini', submitterParameter: 'approver'
...
def deployComponents(envName, targets, Artifact){
	...
	def stepsInParallel = targets.collectEntries {
		echo "DEPLOY $artifactDeploymentLoc and $Artifact"
