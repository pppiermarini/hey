...
emailDistribution="shaque@incomm.com rkale@incomm.com vhari@incomm.com snookala@incomm.com hpokala@incomm.com"
//General pipeline 
...
imageName = "ctps-disbmt-svc"

imageDeploymentLoc="/app/docker/tmp"

Deploy_Config="${Config}"

configLoc="/app/install/disbmt-service/scripts"
gitLoc="src/main/resources/docker/"

gitYmlInstallFile="disbmt-svc-docker-swarm.yml"

commandFile="command.sh"

targetenvs="${targetEnv}"

gitRepository="https://github.com/InComm-Software-Development/ctps-disbursement-service.git"
gitBranch="${Branch}"
gitCreds="scm-incomm"
...
approvalData = [
	'operators': "[ppiermarini,shaque,vhari,snookala,wzhan,hpokala]",
	'adUserOrGroup' : 'ppiermarini,shaque,vhari,snookala,wzhan,hpokala',
